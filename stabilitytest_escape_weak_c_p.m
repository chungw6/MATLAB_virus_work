...
[t1,x]=ode45(@(t,x) escape_model_weak(t, x, 10, 0.008, 0.006, 0.1, 0.5, 0.02, 0.5, 0.1), tspan, xinit);
[t2,x2]=ode45(@(t,x) escape_model_weak(t, x, 10, 0.008, 0.006, 0.1, 0.5, 0.01, 1, 0.1), tspan, xinit);
[t3,x3]=ode45(@(t,x) escape_model_weak(t, x, 10, 0.008, 0.006, 0.1, 0.5, 0.008, 1.25, 0.1), tspan, xinit);
[t4,x4]=ode45(@(t,x) escape_model_weak(t, x, 10, 0.008, 0.006, 0.1, 0.5, 0.005, 2, 0.1), tspan, xinit);
[t5,x5]=ode45(@(t,x) escape_model_weak(t, x, 10, 0.008, 0.006, 0.1, 0.5, 0.004, 2.5, 0.1), tspan, xinit);
...
legend('p = 0.02, c = 0.5','p = 0.01, c = 1', 'p = 0.008, c = 1.25', 'p = 0.005, c = 2', 'p = 0.004, c = 2.5', 'p = 0.002, c = 5', 'p = 0.00125, c = 8', 'p = 0.001, c = 10')
 xlabel('Time')
