...
[t1,x1]=ode45(@(t,x) f_ef_model(t, x, lambda_e, lambda_f, beta_e, beta_f, d, a, p, eta, 0.001, b, g, h), tspan, xinit);
[t2,x2]=ode45(@(t,x) f_ef_model(t, x, lambda_e, lambda_f, beta_e, beta_f, d, a, p, eta, 0.005, b, g, h), tspan, xinit);
[t3,x3]=ode45(@(t,x) f_ef_model(t, x, lambda_e, lambda_f, beta_e, beta_f, d, a, p, eta, 0.01, b, g, h), tspan, xinit);
[t4,x4]=ode45(@(t,x) f_ef_model(t, x, lambda_e, lambda_f, beta_e, beta_f, d, a, p, eta, 0.05, b, g, h), tspan, xinit);
[t5,x5]=ode45(@(t,x) f_ef_model(t, x, lambda_e, lambda_f, beta_e, beta_f, d, a, p, eta, 0.1, b, g, h), tspan, xinit);
[t6,x6]=ode45(@(t,x) f_ef_model(t, x, lambda_e, lambda_f, beta_e, beta_f, d, a, p, eta, 0.5, b, g, h), tspan, xinit);
[t7,x7]=ode45(@(t,x) f_ef_model(t, x, lambda_e, lambda_f, beta_e, beta_f, d, a, p, eta, 1, b, g, h), tspan, xinit);
[t8,x8]=ode45(@(t,x) f_ef_model(t, x, lambda_e, lambda_f, beta_e, beta_f, d, a, p, eta, 5, b, g, h), tspan, xinit);
...
legend('EF, c = 0.001','EF, c = 0.005', 'EF, c = 0.01', 'EF, c = 0.05', 'EF, c = 0.1', 'EF, c = 0.5', 'EF, c = 1', 'EF, c = 5','F, c = 0.001','F, c = 0.005', 'F, c = 0.01', 'F, c = 0.05', 'F, c = 0.1', 'F, c = 0.5', 'F, c = 1', 'F, c = 5')
 xlabel('Time')
