...
[t1,x1]=ode45(@(t,x) f_ef_model(t, x, lambda_e, lambda_f, 0.3, 0.006, d, a, p, eta, c, b, g, h), tspan, xinit);
[t2,x2]=ode45(@(t,x) f_ef_model(t, x, lambda_e, lambda_f, 0.06, 0.006,  d, a, p, eta, c, b, g, h), tspan, xinit);
[t3,x3]=ode45(@(t,x) f_ef_model(t, x, lambda_e, lambda_f, 0.03, 0.006, d, a, p, eta, c, b, g, h), tspan, xinit);
[t4,x4]=ode45(@(t,x) f_ef_model(t, x, lambda_e, lambda_f, 0.006, 0.006, d, a, p, eta, c, b, g, h), tspan, xinit);
[t5,x5]=ode45(@(t,x) f_ef_model(t, x, lambda_e, lambda_f, 0.003, 0.006, d, a, p, eta, c, b, g, h), tspan, xinit);
[t6,x6]=ode45(@(t,x) f_ef_model(t, x, lambda_e, lambda_f, 0.0006, 0.006, d, a, p, eta, c, b, g, h), tspan, xinit);
[t7,x7]=ode45(@(t,x) f_ef_model(t, x, lambda_e, lambda_f, 0.0003, 0.006, d, a, p, eta, c, b, g, h), tspan, xinit);
[t8,x8]=ode45(@(t,x) f_ef_model(t, x, lambda_e, lambda_f, 0.00006, 0.006, d, a, p, eta, c, b, g, h), tspan, xinit);
...
legend('EF, beta_e = 0.3','EF, beta_e = 0.06', 'EF, beta_e = 0.03', 'EF, beta_e = 0.006', 'EF, beta_e = 0.003', 'EF, beta_e = 0.0006', 'EF, beta_e = 0.0003', 'EF, beta_e = 0.0006','F, beta_e = 0.3','F, beta_e = 0.06', 'F, beta_e = 0.03', 'F, beta_e = 0.006', 'F, beta_e = 0.003', 'F, beta_e = 0.0006', 'F, beta_e = 0.0003', 'F, beta_e = 0.0006')
 xlabel('Time')
