...
[t1,x]=ode45(@(t,x) single_strain_weak(t, x, 10, 0.002, 0.1, 0.5, 0.001, 0.02, 0.1), tspan, xinit);
[t2,x2]=ode45(@(t,x) single_strain_weak(t, x, 10, 0.003, 0.1, 0.5, 0.001, 0.02, 0.1), tspan, xinit);
[t3,x3]=ode45(@(t,x) single_strain_weak(t, x, 10, 0.004, 0.1, 0.5, 0.001, 0.02, 0.1), tspan, xinit);
[t4,x4]=ode45(@(t,x) single_strain_weak(t, x, 10, 0.005, 0.1, 0.5, 0.001, 0.02, 0.1), tspan, xinit);
[t5,x5]=ode45(@(t,x) single_strain_weak(t, x, 10, 0.006, 0.1, 0.5, 0.001, 0.02, 0.1), tspan, xinit);
[t6,x6]=ode45(@(t,x) single_strain_weak(t, x, 10, 0.007, 0.1, 0.5, 0.001, 0.02, 0.1), tspan, xinit);
[t7,x7]=ode45(@(t,x) single_strain_weak(t, x, 10, 0.008, 0.1, 0.5, 0.001, 0.02, 0.1), tspan, xinit);
[t8,x8]=ode45(@(t,x) single_strain_weak(t, x, 10, 0.009, 0.1, 0.5, 0.001, 0.02, 0.1), tspan, xinit);
