...
[t1,x1]=ode45(@(t,x) f_ef_model(t, x, lambda_e, lambda_f, beta_e, beta_f, d, a, p, 0.001, c, b, g, h), tspan, xinit);
[t2,x2]=ode45(@(t,x) f_ef_model(t, x, lambda_e, lambda_f, beta_e, beta_f, d, a, p, 0.005, c, b, g, h), tspan, xinit);
[t3,x3]=ode45(@(t,x) f_ef_model(t, x, lambda_e, lambda_f, beta_e, beta_f, d, a, p, 0.01, c, b, g, h), tspan, xinit);
[t4,x4]=ode45(@(t,x) f_ef_model(t, x, lambda_e, lambda_f, beta_e, beta_f, d, a, p, 0.05, c, b, g, h), tspan, xinit);
[t5,x5]=ode45(@(t,x) f_ef_model(t, x, lambda_e, lambda_f, beta_e, beta_f, d, a, p, 0.1, c, b, g, h), tspan, xinit);
[t6,x6]=ode45(@(t,x) f_ef_model(t, x, lambda_e, lambda_f, beta_e, beta_f, d, a, p, 0.5, c, b, g, h), tspan, xinit);
[t7,x7]=ode45(@(t,x) f_ef_model(t, x, lambda_e, lambda_f, beta_e, beta_f, d, a, p, 1, c, b, g, h), tspan, xinit);
[t8,x8]=ode45(@(t,x) f_ef_model(t, x, lambda_e, lambda_f, beta_e, beta_f, d, a, p, 5, c, b, g, h), tspan, xinit);
...
legend('EF, eta = 0.001','EF, eta = 0.005', 'EF, eta = 0.01', 'EF, eta = 0.05', 'EF, eta = 0.1', 'EF, eta = 0.5', 'EF, eta = 1', 'EF, eta = 5','F, eta = 0.001','F, eta = 0.005', 'F, eta = 0.01', 'F, eta = 0.05', 'F, eta = 0.1', 'F, eta = 0.5', 'F, eta = 1', 'F, eta = 5')
 xlabel('Time')
