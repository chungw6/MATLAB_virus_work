...
[t1,x1]=ode45(@(t,x) f_ef_model(t, x, lambda_e, lambda_f, beta_e, beta_f, d, a, p, eta, c, b, g, h), tspan, xinit);
[t2,x2]=ode45(@(t,x) f_ef_model(t, x, lambda_e, lambda_f, beta_e, beta_f, d, a, p, eta, c, b, g, h), tspan, xinit);
[t3,x3]=ode45(@(t,x) f_ef_model(t, x, lambda_e, lambda_f, beta_e, beta_f, d, a, p, eta, c, b, g, h), tspan, xinit);
[t4,x4]=ode45(@(t,x) f_ef_model(t, x, lambda_e, lambda_f, beta_e, beta_f, d, a, p, eta, c, b, g, h), tspan, xinit);
[t5,x5]=ode45(@(t,x) f_ef_model(t, x, lambda_e, lambda_f, beta_e, beta_f, d, a, p, eta, c, b, g, h), tspan, xinit);
[t6,x6]=ode45(@(t,x) f_ef_model(t, x, lambda_e, lambda_f, beta_e, beta_f, d, a, p, eta, c, b, g, h), tspan, xinit);
[t7,x7]=ode45(@(t,x) f_ef_model(t, x, lambda_e, lambda_f, beta_e, beta_f, d, a, p, eta, c, b, g, h), tspan, xinit);
[t8,x8]=ode45(@(t,x) f_ef_model(t, x, lambda_e, lambda_f, beta_e, beta_f, d, a, p, eta, c, b, g, h), tspan, xinit);
